...
* The reason for this is that our observed data (8 out of 15 tosses) supports the prior assumption, which makes us more confident of the data sooner, but the observed proportion in this case is `0.533`, far from the true `p = 0.7`.
